...
export interface SendToAddressRequest {
    /**
     * The NEXT address to send to.
     */
    nextaddress: string;
    /**
     * The amount in NEXT to send. eg 0.1
     */
    amount: number;
    /**
    ...
    commentto?: string;
    /**
     * The fee will be deducted from the amount being sent. The recipient will receive less NEXT than you enter in the amount field.
     */
