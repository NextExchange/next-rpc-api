...
export interface RPCServiceFunctions {
    ...
    listReceivedByAddress(minConf?: number, includeEmpty?: boolean, includeWatchOnly?: boolean, addressFilter?: string): JsonRpcCall<NextcoinAddressEntry[]>;
